...
evaluationDependsOn(":packages:neoforge-26.2")

val targetMinecraftVersion = "26.2"
val neoForgeVersion = "26.2.0.32-beta"
val jcefGithubVersion = libs.versions.jcefgithub.get()
val grapheneProject = project(":packages:neoforge-26.2")
...
dependencies {
  implementation(project(":packages:neoforge-26.2"))
